...
async function ProductsData({ inventoryId, dateFrom, dateTo, accountingPeriodId }: { inventoryId?: number; dateFrom?: string; dateTo?: string; accountingPeriodId?: number }) {
  const [rows, t] = await Promise.all([
    getProductReport({ inventoryId, dateFrom, dateTo, accountingPeriodId }),
