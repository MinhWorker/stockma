...
async function ProvidersData({ inventoryId, dateFrom, dateTo, accountingPeriodId }: { inventoryId?: number; dateFrom?: string; dateTo?: string; accountingPeriodId?: number }) {
  const [rows, t] = await Promise.all([
    getProviderReport({ inventoryId, dateFrom, dateTo, accountingPeriodId }),
